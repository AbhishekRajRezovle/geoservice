...
public class ApplicationConstants {
    ...
    public static final Integer HTTP_RESPONSE_ERROR_CODE_NOT_FOUND = 404;
    public static final String HTTP_RESPONSE_ERROR_CODE_NOT_FOUND_MSG = "Data with given id not found";
